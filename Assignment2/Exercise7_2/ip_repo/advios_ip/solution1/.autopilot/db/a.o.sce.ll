...
codeRepl:
  ...
  call void @llvm.dbg.value(metadata !{i1* %clk_second}, i64 0, metadata !104), !dbg !1099
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !1100), !dbg !1099
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !1107), !dbg !1099
  call void @llvm.dbg.value(metadata !{i4* %ctrl}, i64 0, metadata !1108), !dbg !1099
  call void @llvm.dbg.value(metadata !{i4* %switches}, i64 0, metadata !1124), !dbg !1099
  call void @llvm.dbg.value(metadata !{i4* %leds}, i64 0, metadata !1125), !dbg !1099
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !1136
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !1138
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %ctrl) nounwind, !dbg !1139
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %switches) nounwind, !dbg !1140
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [5 x i8]* @p_str7, i32 0, i32 0, i4* %leds) nounwind, !dbg !1141
  call void (...)* @_ssdm_op_SpecProcessDef([7 x i8]* @p_str, i32 2, [15 x i8]* @p_str8) nounwind, !dbg !1142
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !1143
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !1144
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !1145
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !1146), !dbg !1145
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1147
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_2), !dbg !1148
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !1149
...
_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge, %codeRepl
  ...
  %clock_counter_V_load = load i26* @clock_counter_V, align 4, !dbg !1158
  %clock_counter_V_assi = add i26 %clock_counter_V_load, 1, !dbg !1421
  store i26 %clock_counter_V_assi, i26* @clock_counter_V, align 4, !dbg !1421
  %tmp_1 = icmp eq i26 %clock_counter_V_assi, -17108864, !dbg !1676
  br i1 %tmp_1, label %0, label %_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge, !dbg !2227

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit
  call void @llvm.dbg.value(metadata !{i1* %clk_second}, i64 0, metadata !2228), !dbg !2236
  %tmp = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %clk_second), !dbg !2242
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !2244), !dbg !2237
  %v = xor i1 %tmp, true, !dbg !2240
  call void @llvm.dbg.value(metadata !{i1 %v}, i64 0, metadata !2245), !dbg !2248
  call void @llvm.dbg.value(metadata !{i1* %clk_second}, i64 0, metadata !2249), !dbg !2255
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %clk_second, i1 %v), !dbg !2257
  store i26 0, i26* @clock_counter_V, align 4, !dbg !2259
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge, !dbg !2355

_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge:       ; preds = %0, %_ZN7_ap_sc_7sc_core4waitEi.exit
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2356
}
...
codeRepl:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %switches), !map !96
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %leds), !map !100
  call void @llvm.dbg.value(metadata !{i1* %clk_second}, i64 0, metadata !2357), !dbg !2360
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !2361), !dbg !2360
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !2362), !dbg !2360
  call void @llvm.dbg.value(metadata !{i4* %ctrl}, i64 0, metadata !2363), !dbg !2360
  call void @llvm.dbg.value(metadata !{i4* %switches}, i64 0, metadata !2364), !dbg !2360
  call void @llvm.dbg.value(metadata !{i4* %leds}, i64 0, metadata !2365), !dbg !2360
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !2366
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !2368
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %ctrl) nounwind, !dbg !2369
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %switches) nounwind, !dbg !2370
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [5 x i8]* @p_str7, i32 0, i32 0, i4* %leds) nounwind, !dbg !2371
  call void (...)* @_ssdm_op_SpecProcessDef([7 x i8]* @p_str, i32 2, [11 x i8]* @p_str13) nounwind, !dbg !2372
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !2373
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !2374
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !2375
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !2376), !dbg !2375
  call void (...)* @_ssdm_op_SpecIFCore(i4* %ctrl, [1 x i8]* @p_str10, [10 x i8]* @p_str14, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str15), !dbg !2377
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !2378
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_5), !dbg !2379
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2380

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge, %codeRepl
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2381
  %last_clock_load = load i1* @last_clock, align 1, !dbg !2384
  br i1 %last_clock_load, label %_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge, label %0, !dbg !2384

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit
  call void @llvm.dbg.value(metadata !{i1* %clk_second}, i64 0, metadata !2228), !dbg !2385
  %tmp = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %clk_second), !dbg !2388
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !2244), !dbg !2386
  br i1 %tmp, label %1, label %_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge, !dbg !2387

; <label>:1                                       ; preds = %0
  %val_V = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %ctrl), !dbg !2389
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !2408), !dbg !2389
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !2410), !dbg !2412
  %val_V_1 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %switches), !dbg !2415
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !2408), !dbg !2415
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !2420), !dbg !2422
  %tmp_3 = icmp eq i4 %val_V, 0, !dbg !2423
  br i1 %tmp_3, label %2, label %6, !dbg !2434

; <label>:2                                       ; preds = %1
  %tmp_4 = icmp eq i4 %val_V_1, -8, !dbg !2435
  br i1 %tmp_4, label %3, label %4, !dbg !2437

; <label>:3                                       ; preds = %2
  store i4 0, i4* @counter_V, align 1, !dbg !2439
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %leds, i4 0), !dbg !2442
  br label %5, !dbg !2463

; <label>:4                                       ; preds = %2
  %counter_V_load = load i4* @counter_V, align 1, !dbg !2464
  %v_V_1 = add i4 %counter_V_load, 1, !dbg !2469
  store i4 %v_V_1, i4* @counter_V, align 1, !dbg !2469
  call void @llvm.dbg.value(metadata !{i4 %v_V_1}, i64 0, metadata !2475), !dbg !2477
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %leds, i4 %v_V_1), !dbg !2480
  br label %5
...
; <label>:6                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !2484), !dbg !2493
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !2496), !dbg !2493
  %r_V = and i4 %val_V_1, %val_V, !dbg !2493
  call void @llvm.dbg.value(metadata !{i4 %r_V}, i64 0, metadata !2498), !dbg !2493
  call void @llvm.dbg.value(metadata !{i4 %r_V}, i64 0, metadata !2475), !dbg !2501
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %leds, i4 %r_V), !dbg !2503
  br label %7

; <label>:7                                       ; preds = %6, %5
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge, !dbg !2506

_ZN7_ap_sc_7sc_core4waitEi.exit._crit_edge:       ; preds = %7, %0, %_ZN7_ap_sc_7sc_core4waitEi.exit
  call void @llvm.dbg.value(metadata !{i1* %clk_second}, i64 0, metadata !2228), !dbg !2507
  %tmp_1 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %clk_second), !dbg !2510
  call void @llvm.dbg.value(metadata !{i1 %tmp_1}, i64 0, metadata !2244), !dbg !2508
  store i1 %tmp_1, i1* @last_clock, align 1, !dbg !2509
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2511
}
...
define weak void @"Advios::Advios"(i1* %clk_second, i1* %clk, i1* %reset, i4* %ctrl, i4* %switches, i4* %leds) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %switches), !map !96
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %leds), !map !100
  call void @llvm.dbg.value(metadata !{i1* %clk_second}, i64 0, metadata !2512), !dbg !2515
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !2516), !dbg !2515
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !2517), !dbg !2515
  call void @llvm.dbg.value(metadata !{i4* %ctrl}, i64 0, metadata !2518), !dbg !2515
  call void @llvm.dbg.value(metadata !{i4* %switches}, i64 0, metadata !2519), !dbg !2515
  call void @llvm.dbg.value(metadata !{i4* %leds}, i64 0, metadata !2520), !dbg !2515
  call void (...)* @_ssdm_op_SpecTopModule([7 x i8]* @p_str, [7 x i8]* @p_str) nounwind, !dbg !2521
  %Advios_ssdm_threa = load i1* @Advios_ssdm_thread_M_modulate_clock, align 1, !dbg !2523
  br i1 %Advios_ssdm_threa, label %1, label %2, !dbg !2523

; <label>:1                                       ; preds = %0
  call void @"Advios::modulate_clock"(i1* %clk_second, i1* %clk, i1* %reset, i4* %ctrl, i4* %switches, i4* %leds), !dbg !2524
  br label %UnifiedUnreachableBlock

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([7 x i8]* @p_str, i32 2, [15 x i8]* @p_str8) nounwind, !dbg !2525
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str8, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !2526
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str8, [6 x i8]* @p_str3, i1* %reset, i32 3) nounwind, !dbg !2527
  %Advios_ssdm_threa_1 = load i1* @Advios_ssdm_thread_M_LedControl, align 1, !dbg !2528
  br i1 %Advios_ssdm_threa_1, label %3, label %4, !dbg !2528

; <label>:3                                       ; preds = %2
  call void @"Advios::LedControl"(i1* %clk_second, i1* %clk, i1* %reset, i4* %ctrl, i4* %switches, i4* %leds), !dbg !2529
  br label %UnifiedUnreachableBlock

; <label>:4                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecProcessDecl([7 x i8]* @p_str, i32 2, [11 x i8]* @p_str13) nounwind, !dbg !2530
  call void (...)* @_ssdm_op_SpecSensitive([11 x i8]* @p_str13, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !2531
  call void (...)* @_ssdm_op_SpecSensitive([11 x i8]* @p_str13, [6 x i8]* @p_str3, i1* %reset, i32 3) nounwind, !dbg !2532
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !2533
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !2534
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %ctrl) nounwind, !dbg !2535
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %switches) nounwind, !dbg !2536
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [5 x i8]* @p_str7, i32 0, i32 0, i4* %leds) nounwind, !dbg !2537
  call void (...)* @_ssdm_op_SpecChannel([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [11 x i8]* @p_str12, i32 1, i32 0, i1* %clk_second) nounwind, !dbg !2538
  ret void, !dbg !2539
