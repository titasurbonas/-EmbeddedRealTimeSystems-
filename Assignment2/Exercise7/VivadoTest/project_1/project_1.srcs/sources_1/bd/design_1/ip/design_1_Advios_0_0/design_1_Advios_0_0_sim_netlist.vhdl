...
entity design_1_Advios_0_0_Advios_LedControl is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_Advios_0_0_Advios_LedControl : entity is "Advios_LedControl";
end design_1_Advios_0_0_Advios_LedControl;

architecture STRUCTURE of design_1_Advios_0_0_Advios_LedControl is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_Advios_0_0_Advios_modulate_clock is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_Advios_0_0_Advios_modulate_clock : entity is "Advios_modulate_clock";
end design_1_Advios_0_0_Advios_modulate_clock;

architecture STRUCTURE of design_1_Advios_0_0_Advios_modulate_clock is
...
grp_Advios_LedControl_fu_78: entity work.design_1_Advios_0_0_Advios_LedControl
     port map (
      D(0) => D(0),
      Q(0) => Q(0),
      SS(0) => \^sr\(0),
...
grp_Advios_modulate_clock_fu_98: entity work.design_1_Advios_0_0_Advios_modulate_clock
     port map (
      SS(0) => \^sr\(0),
      aclk => aclk,
      aresetn => aresetn,
