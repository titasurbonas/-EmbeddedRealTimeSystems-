...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_mul_16s_1bkb_U1->din0(reg_141);
    fir_mul_mul_16s_1bkb_U1->din1(acc_fu_198_p1);
    fir_mul_mul_16s_1bkb_U1->dout(acc_fu_198_p2);
    fir_mac_muladd_16cud_U2 = new fir_mac_muladd_16cud<1,1,16,16,37,37>("fir_mac_muladd_16cud_U2");
    fir_mac_muladd_16cud_U2->din0(reg_141);
    fir_mac_muladd_16cud_U2->din1(c_load_reg_261);
    fir_mac_muladd_16cud_U2->din2(acc1_reg_120);
    fir_mac_muladd_16cud_U2->dout(grp_fu_204_p3);
    fir_mac_muladd_10dEe_U3 = new fir_mac_muladd_10dEe<1,1,10,16,31,31>("fir_mac_muladd_10dEe_U3");
    fir_mac_muladd_10dEe_U3->din0(grp_fu_212_p0);
    fir_mac_muladd_10dEe_U3->din1(x_read_reg_226);
    fir_mac_muladd_10dEe_U3->din2(grp_fu_212_p2);
    fir_mac_muladd_10dEe_U3->dout(grp_fu_212_p3);

    SC_METHOD(thread_ap_clk_no_reset_);
    dont_initialize();
    sensitive << ( ap_clk.pos() );

    SC_METHOD(thread_acc_cast_fu_149_p1);
    sensitive << ( acc_reg_221 );

    SC_METHOD(thread_acc_fu_198_p1);
    ...
    SC_METHOD(thread_tmp_3_fu_152_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_phi_mux_i_phi_fu_134_p4 );

    SC_METHOD(thread_tmp_6_fu_169_p1);
    sensitive << ( ap_phi_mux_i_phi_fu_134_p4 );
    ...
    sc_trace(mVcdFile, acc_fu_198_p2, "acc_fu_198_p2");
    sc_trace(mVcdFile, acc_reg_221, "acc_reg_221");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, x_read_reg_226, "x_read_reg_226");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, acc_cast_fu_149_p1, "acc_cast_fu_149_p1");
    sc_trace(mVcdFile, tmp_3_fu_152_p2, "tmp_3_fu_152_p2");
    sc_trace(mVcdFile, tmp_3_reg_237_pp0_iter1_reg, "tmp_3_reg_237_pp0_iter1_reg");
    sc_trace(mVcdFile, i_1_fu_158_p2, "i_1_fu_158_p2");
    sc_trace(mVcdFile, i_1_reg_241, "i_1_reg_241");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter0, "ap_enable_reg_pp0_iter0");
    sc_trace(mVcdFile, tmp_6_fu_169_p1, "tmp_6_fu_169_p1");
    sc_trace(mVcdFile, tmp_6_reg_251, "tmp_6_reg_251");
    ...
    sc_trace(mVcdFile, grp_fu_212_p3, "grp_fu_212_p3");
    sc_trace(mVcdFile, acc_fu_198_p1, "acc_fu_198_p1");
...
void fir::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, tmp_3_reg_237_pp0_iter1_reg.read()))) {
        acc1_reg_120 = grp_fu_204_p3.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        acc1_reg_120 = acc_cast_fu_149_p1.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(tmp_3_reg_237.read(), ap_const_lv1_0))) {
        i_reg_130 = i_1_reg_241.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_reg_130 = ap_const_lv6_39;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        acc_reg_221 = acc_fu_198_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(tmp_3_reg_237.read(), ap_const_lv1_0))) {
        c_load_reg_261 = c_q0.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter0.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_3_fu_152_p2.read()))) {
  ...
  esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(tmp_3_reg_237.read(), ap_const_lv1_0)))) {
        reg_141 = shift_reg_q0.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_3_reg_237 = tmp_3_fu_152_p2.read();
        tmp_3_reg_237_pp0_iter1_reg = tmp_3_reg_237.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_3_fu_152_p2.read()))) {
        tmp_6_reg_251 = tmp_6_fu_169_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        x_read_reg_226 = x.read();
    }
}

void fir::thread_acc_cast_fu_149_p1() {
    acc_cast_fu_149_p1 = esl_sext<37,26>(acc_reg_221.read());
}

void fir::thread_acc_fu_198_p1() {
    acc_fu_198_p1 =  (sc_lv<10>) (ap_const_lv26_3FFFE86);
}
...
void fir::thread_ap_condition_pp0_exit_iter0_state5() {
    if (esl_seteq<1,1,1>(tmp_3_fu_152_p2.read(), ap_const_lv1_1)) {
...
void fir::thread_ap_phi_mux_i_phi_fu_134_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        ap_phi_mux_i_phi_fu_134_p4 = i_1_reg_241.read();
    } else {
...
void fir::thread_c_address0() {
    c_address0 =  (sc_lv<6>) (tmp_6_fu_169_p1.read());
}
...
void fir::thread_grp_fu_212_p0() {
    grp_fu_212_p0 =  (sc_lv<10>) (ap_const_lv26_3FFFE86);
}

void fir::thread_grp_fu_212_p2() {
    grp_fu_212_p2 = acc1_reg_120.read().range(31-1, 0);
}

void fir::thread_i_1_fu_158_p2() {
    i_1_fu_158_p2 = (!ap_phi_mux_i_phi_fu_134_p4.read().is_01() || !ap_const_lv6_3F.is_01())? sc_lv<6>(): (sc_biguint<6>(ap_phi_mux_i_phi_fu_134_p4.read()) + sc_bigint<6>(ap_const_lv6_3F));
}
...
void fir::thread_shift_reg_address0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_enable_reg_pp0_iter0.read(), ap_const_logic_1) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
        shift_reg_address0 =  (sc_lv<6>) (tmp_s_fu_164_p1.read());
...
void fir::thread_shift_reg_address1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        shift_reg_address1 = ap_const_lv6_0;
                ...
                esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
                esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
        shift_reg_address1 =  (sc_lv<6>) (tmp_6_reg_251.read());
    } else {
...
void fir::thread_shift_reg_d1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        shift_reg_d1 = x_read_reg_226.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
                esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
...
void fir::thread_tmp_3_fu_152_p2() {
    tmp_3_fu_152_p2 = (!ap_phi_mux_i_phi_fu_134_p4.read().is_01() || !ap_const_lv6_0.is_01())? sc_lv<1>(): sc_lv<1>(ap_phi_mux_i_phi_fu_134_p4.read() == ap_const_lv6_0);
}

void fir::thread_tmp_6_fu_169_p1() {
    tmp_6_fu_169_p1 = esl_zext<64,6>(ap_phi_mux_i_phi_fu_134_p4.read());
}

void fir::thread_tmp_s_fu_164_p1() {
    tmp_s_fu_164_p1 = esl_zext<64,6>(i_1_fu_158_p2.read());
}

void fir::thread_y() {
    y = grp_fu_212_p3.read().range(30, 15);
}
...
void fir::thread_ap_NS_fsm() {
  ...
  esl_seteq<1,1,1>(ap_const_boolean_0, ap_block_pp0_stage0_subdone.read()) && 
  esl_seteq<1,1,1>(tmp_3_fu_152_p2.read(), ap_const_lv1_1) && 
