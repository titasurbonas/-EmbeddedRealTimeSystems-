...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net fir_left_interrupt [get_bd_pins fir_left/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net fir_right_interrupt [get_bd_pins fir_right/interrupt] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net xlconcat_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
