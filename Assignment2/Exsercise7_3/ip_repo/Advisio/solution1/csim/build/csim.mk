...
HLS_SOURCES = ../../../Advios_testbench.cpp ../../../Advios.cpp ../../../Top.cpp
...
$(ObjDir)/Advios_testbench.o: ../../../Advios_testbench.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../Advios_testbench.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -DHW_COSIM  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Advios_testbench.d

$(ObjDir)/Advios.o: ../../../Advios.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../Advios.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
