...
(* CORE_GENERATION_INFO="matrixmul,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.380000,HLS_SYN_LAT=106,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=1,HLS_SYN_FF=61,HLS_SYN_LUT=189,HLS_VERSION=2018_2}" *)
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_158_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        res_addr_reg_279 <= tmp_11_cast_fu_179_p1;
        tmp_2_cast_reg_274[1 : 0] <= tmp_2_cast_fu_170_p1[1 : 0];
    end
end
...
assign tmp_12_fu_228_p2 = (tmp_11_fu_222_p2 + tmp_2_cast_reg_274);

assign tmp_15_cast_fu_233_p1 = $signed(tmp_12_fu_228_p2);

assign tmp_2_cast_fu_170_p1 = j_reg_89;

assign tmp_2_fu_174_p2 = (tmp_s_reg_260 + tmp_2_cast_fu_170_p1);

assign tmp_4_cast_fu_196_p1 = k_reg_113;

assign tmp_4_fu_200_p2 = (tmp_s_reg_260 + tmp_4_cast_fu_196_p1);
