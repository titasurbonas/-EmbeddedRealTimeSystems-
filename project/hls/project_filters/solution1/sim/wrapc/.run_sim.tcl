...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "apply.autotvin.dat"
	set constFileTvOut       "apply.autotvout.dat"
	set constFileHdlTvIn     "apply.autohdltvin.dat"
	set constFileHdlTvOut    "apply.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
