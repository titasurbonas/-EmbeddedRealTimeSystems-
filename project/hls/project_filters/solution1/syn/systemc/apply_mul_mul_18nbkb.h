...
#ifndef __apply_mul_mul_18nbkb__HH__
#define __apply_mul_mul_18nbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(apply_mul_mul_18nbkb) {
    ...
    SC_CTOR(apply_mul_mul_18nbkb):  ACMP_smul_us_U ("ACMP_smul_us_U") {
