...
HD_PWD='/home/olafur/Documents/Embedded_systems/-EmbeddedRealTimeSystems-/project/hls/project_filters/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apply.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apply.tcl
