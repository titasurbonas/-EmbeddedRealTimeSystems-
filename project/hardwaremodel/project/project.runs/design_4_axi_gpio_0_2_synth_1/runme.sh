...
HD_PWD='/home/olafur/Documents/Embedded_systems/-EmbeddedRealTimeSystems-/project/hardwaremodel/project/project.runs/design_4_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_4_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_4_axi_gpio_0_2.tcl
