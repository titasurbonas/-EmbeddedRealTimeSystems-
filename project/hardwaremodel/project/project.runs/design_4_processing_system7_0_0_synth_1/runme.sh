...
HD_PWD='/home/olafur/Documents/Embedded_systems/-EmbeddedRealTimeSystems-/project/hardwaremodel/project/project.runs/design_4_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_4_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_4_processing_system7_0_0.tcl
