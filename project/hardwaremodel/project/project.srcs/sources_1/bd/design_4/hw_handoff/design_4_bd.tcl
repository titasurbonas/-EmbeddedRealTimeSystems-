...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_gpio_LEDS_GPIO [get_bd_intf_ports gpio_rtl] [get_bd_intf_pins axi_gpio_LEDS/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_SWS_GPIO [get_bd_intf_ports sws_4bits] [get_bd_intf_pins axi_gpio_SWS/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins zybo_audio_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_SWS/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_BTN/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_BTN/s_axi_aresetn] [get_bd_pins axi_gpio_LEDS/s_axi_aresetn] [get_bd_pins axi_gpio_SWS/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins zybo_audio_ctrl_0/S_AXI_ARESETN]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_BTN/S_AXI/Reg] SEG_axi_gpio_BTN_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_LEDS/S_AXI/Reg] SEG_axi_gpio_LEDS_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_SWS/S_AXI/Reg] SEG_axi_gpio_SWS_Reg
