...
targets -set -filter {jtag_cable_name =~ "Digilent Zybo 210279A6A4AAA" && level==0} -index 1
fpga -file /home/olafur/Documents/Embedded_systems/-EmbeddedRealTimeSystems-/project/lab_based_hardware/audio/audio.sdk/system_wrapper_hw_platform_2/system_wrapper.bit
...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279A6A4AAA"} -index 0
dow /home/olafur/Documents/Embedded_systems/-EmbeddedRealTimeSystems-/project/lab_based_hardware/audio/audio.sdk/Solution5/Debug/Solution5.elf
