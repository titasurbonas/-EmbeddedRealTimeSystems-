...
HD_PWD='/home/olafur/Documents/Embedded_systems/-EmbeddedRealTimeSystems-/project/lab_based_hardware/audio/audio.runs/system_apply_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_apply_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_apply_1_0.tcl
