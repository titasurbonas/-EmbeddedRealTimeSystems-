...
HD_PWD='/home/olafur/Documents/Embedded_systems/-EmbeddedRealTimeSystems-/project/lab_based_hardware/audio/audio.runs/system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
